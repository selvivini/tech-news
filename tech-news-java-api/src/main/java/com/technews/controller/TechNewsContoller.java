...
@Controller
public class TechNewsContoller {
    @Autowired
    ...
    @PostMapping("/posts")
    public String addPostDashboardPage(@ModelAttribute Posts post, Model model, HttpServletRequest request) {
    ...
    public String updatePostDashboardPage(@PathVariable int id, @ModelAttribute Posts post, Model model, HttpServletRequest request) {

        if (request.getSession(false) == null) {
            model.addAttribute("user", new User());
            return "redirect/dashboard";
        } else {
            Posts tempPost = postRepository.getById(id);
